...
wget -O custom_package_items.conf https://raw.githubusercontent.com/hvmediavn/wp-cli-DA/main/DA_WP/data/custom_package_items.conf
...
wget -O custom_domain_items.conf https://raw.githubusercontent.com/hvmediavn/wp-cli-DA/main/DA_WP/data/custom_domain_items.conf
...
wget -O domain_create_post.sh https://raw.githubusercontent.com/hvmediavn/wp-cli-DA/main/DA_WP/scripts/domain_create_post.sh
...
wget -O subdomain_create_post.sh https://raw.githubusercontent.com/hvmediavn/wp-cli-DA/main/DA_WP/scripts/subdomain_create_post.sh
...
wget -O domain_modify_post.sh https://raw.githubusercontent.com/hvmediavn/wp-cli-DA/main/DA_WP/scripts/domain_modify_post.sh
